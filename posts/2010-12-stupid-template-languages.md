...
Hanno,<br /><br />Thanks for the clarification. Chameleon looks awesome, and if I ever used it I would write something that would check for xmlns:metal=&quot;http://xml.zope.org/namespaces/metal&quot; in the templates and raise an error if it found it. :)
